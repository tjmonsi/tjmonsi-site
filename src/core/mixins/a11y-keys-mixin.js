...
function parseKeyComboString (keyComboString) {
  ...
  return keyComboString.split('+').reduce((parsedKeyCombo, keyComboPart) => {
...
function parseEventString (eventString) {
  return eventString.trim().split(' ').map((keyComboString) => {
...
export default superClass => {
  return class extends superClass {
    ...
    keyboardEventMatchesKeys (event, eventString) {
      return keyboardEventMatchesKeys(event, eventString);
    }
...
export const keyboardEventMatchesKeys = (event, eventString) => {
